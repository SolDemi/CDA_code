...
for s = 1:nSubs
    ...
    tempDat = [erp.trial.L_S2; erp.trial.L_S6; ...
        erp.trial.R_S2; erp.trial.R_S6; ];
    
    labels = [ones(size(erp.trial.L_S2,1),1)*2; ones(size(erp.trial.L_S6,1),1)*6; ...
...
save([pwd,'/CDA_classification/load_classify_diagLinear_iterations_shape.mat'],'cls')
