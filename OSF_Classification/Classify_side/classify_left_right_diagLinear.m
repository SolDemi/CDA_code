...
for s = 1:nSubs
    ...
    cls_acc_lr_allchans = NaN(1,nBins);
    cls_acc_lr_allchans_shuffle = NaN(1,nBins);
    ...
    for b = 1:nBins
        ...
        % Save accuracy!
        cls_acc_lr_allchans(b) = 1 -  errRate;
        ...
        % Save accuracy!
        cls_acc_lr_allchans_shuffle(b) = 1 - errRate;
            
        fprintf('.');
    end % end time bins loop!
    
    cls.acc_lr_allchans(s,:) = cls_acc_lr_allchans;
    cls.acc_lr_allchans_shuffle(s,:) = cls_acc_lr_allchans_shuffle;
    
    fprintf(sprintf('\n Subject %d out of %d finished \n',s,nSubs));
end % end subject loop

save([pwd,'/CDA_classification/left_right_classify_diagLinear.mat'],'cls','subjects')
