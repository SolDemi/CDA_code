...
load left_right_classify_diagLinear.mat
...
errorbar(cls.binCenters, mean(cls.acc_lr_allchans), std(cls.acc_lr_allchans) ./ sqrt(nSubs), 'b', 'LineWidth',3)
errorbar(cls.binCenters, mean(svmClass.acc_lr_allchans), std(svmClass.acc_lr_allchans) ./ sqrt(nSubs), 'r', 'LineWidth',3)
errorbar(cls.binCenters, mean(cls.acc_lr_allchans_shuffle), std(cls.acc_lr_allchans_shuffle) ./ sqrt(nSubs), 'k', 'LineWidth',3)
...
errorbar(cls.binCenters, mean(cls.acc_lr_allchans(1:nSubs,:)), std(cls.acc_lr_allchans(1:nSubs,:)) ./ sqrt(nSubs), 'b', 'LineWidth',3)
errorbar(cls.binCenters, mean(cls.acc_lr_allchans_shuffle(1:nSubs,:)), std(cls.acc_lr_allchans_shuffle(1:nSubs,:)) ./ sqrt(nSubs), 'r', 'LineWidth',3)
plot(cls.binCenters,cls.acc_lr_allchans(1:nSubs,:)','Color',[0 0 0 .3])
errorbar(cls.binCenters, mean(cls.acc_lr_allchans(1:nSubs,:)), std(cls.acc_lr_allchans(1:nSubs,:)) ./ sqrt(nSubs), 'b', 'LineWidth',3)
errorbar(cls.binCenters, mean(cls.acc_lr_allchans_shuffle(1:nSubs,:)), std(cls.acc_lr_allchans_shuffle(1:nSubs,:)) ./ sqrt(nSubs), 'r', 'LineWidth',3)
xlim([min(cls.binCenters),max(cls.binCenters)])
